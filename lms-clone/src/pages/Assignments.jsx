            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 pt-7">
                <div className="mb-4 flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-neutral-400 text-sm">Search, filter and sort your assignments.</p>
                    </div>
                    <a className="text-sm text-neutral-300 hover:text-white underline" href="/student" data-discover="true">← Back to Dashboard</a>
                </div>
                <div className="rounded-xl border border-neutral-800 bg-neutral-900 mb-4">
                    <div className="p-4">
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                            <div className="md:col-span-2">
                                <input placeholder="Search by heading" className="w-full rounded-md bg-neutral-950 border border-neutral-700 text-neutral-100 text-sm px-3 py-2 outline-none focus:border-neutral-500" value="" />
                            </div>
                            <div>
                ...
                <div className="rounded-xl border border-neutral-800 bg-neutral-900">
                    ...
                    <div className="p-4">
                        <div className="text-neutral-400 text-sm">No assignments found.</div>
                    </div>
                </div>
            </div>
        </>
